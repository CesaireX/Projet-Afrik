...
<h2 style="text-align: center; margin-top: 50px; text-transform: uppercase;"> <U>ETABLISSEMENT DU BILAN GENERAL DES @if($type=="OK") CAUTIONS @else {{$type}} @endif SOUMISSES ENTRE {{$date1}} et {{$date2}}</U></h2><br><br>
