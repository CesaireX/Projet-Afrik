...
<body style="background-color: rgb(255, 255, 255)">
    ...
    <h3 style="text-align: left;">  </h3>
                                ...
                                <h3 style="text-align: center; margin-top: 50px;"> ETABLISSEMENT DU BILAN GENERAL DES CAUTIONS DE RETENUE DE GARANTIE </h3><br><br>
...
<h4 style="text-align: left;">Montant total des cautions: {{$montant}} FCFA</h4><a href="{{route('impression.retenue')}}" class="btn btn-primary" style="margin-left: 1000px; margin-top: -32px;"><i class="fa fa-print"></i> Imprimer</a><a href="{{ route('caution.prevenir') }}" class="btn btn-success" style="margin-left: 1200px; margin-top: -80px;"><i class="fa fa-home"></i> HOME </a><br>
